...
class Settings(BaseSettings):
    ...
    GEMINI_QC_MODEL: str = Field(default="gemini-3-flash-preview")
    GEMINI_QC_TEMPERATURE: float = Field(default=0.4)
    GEMINI_QC_MAX_OUTPUT_TOKENS: int = Field(default=12000)
